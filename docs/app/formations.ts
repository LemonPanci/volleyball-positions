...
export function getReceiveP1(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getReceiveP2(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getReceiveP3(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getReceiveP4(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getReceiveP5(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getReceiveP6(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getNeutralDefenseP1(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getNeutralDefenseP2(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getNeutralDefenseP3(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getNeutralDefenseP4(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getNeutralDefenseP5(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getNeutralDefenseP6(x: number, y: number, courtSize: number, roles: string[]): Formation {
...
export function getNoFrontSwapDefenseP1(x: number, y: number, courtSize: number, roles: string[]): Formation {
    const formation_p1 = new Formation(x, y, courtSize, roles, 0, true);
    formation_p1.updateCourtPositionByIndex(0, 4 / 5 * courtSize, 3 / 5 * courtSize);
